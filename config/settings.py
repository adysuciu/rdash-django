...
env = environ.Env(
    ...
    JAM_STORAGE_SHEET_ID=(str, ""),
    JAM_STORAGE_SHEET_GID=(str, "0"),
    JAM_STORAGE_REFRESH_SECONDS=(int, 604800),
)
...
JAM_STORAGE_SHEET_ID = env("JAM_STORAGE_SHEET_ID")
JAM_STORAGE_SHEET_GID = env("JAM_STORAGE_SHEET_GID")
JAM_STORAGE_REFRESH_SECONDS = env.int("JAM_STORAGE_REFRESH_SECONDS")
